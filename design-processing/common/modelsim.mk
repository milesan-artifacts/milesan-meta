...
# DIT only for ibex!
MODELSIM_SV_HANDSHAKE_PROBES = generated/out/handshake_probes.sv dv/sv/tb_top.sv src/$(TOP_SOC).sv $(MILESAN_DESIGN_PROCESSING_ROOT)/common/src/sram_mem.sv
...
build_drfuzz_mem_muxcov_notrace_modelsim:         $(MODELSIM_PATH_TO_BUILD_TCL) $(MODELSIM_SV_DRFUZZ_MEM_MUXCOV)     | $(MODELSIM_WORKDIR) modelsim traces logs
