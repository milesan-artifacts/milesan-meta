...
CHECK_REGS_TAINT_PRECISE = get_env_bool('CHECK_REGS_TAINT_PRECISE', str(int(CHECK_REGS_TAINT_PRECISE_DEFAULT)))
CHECK_MEM_TAINT_PRECISE = get_env_bool('CHECK_MEM_TAINT_PRECISE', str(int(CHECK_MEM_TAINT_PRECISE_DEFAULT)))
CHECK_MEM = get_env_bool('CHECK_MEM', str(int(CHECK_MEM_DEFAULT)))
PRINT_CHECK_REGS_TAINT = get_env_bool('PRINT_CHECK_REGS_TAINT', str(int(PRINT_CHECK_REGS_TAINT_DEFAULT)))
PRINT_CHECK_REGS_TAINT_MISMATCH_OK = get_env_bool('PRINT_CHECK_REGS_TAINT_MISMATCH_OK', str(int(PRINT_CHECK_REGS_TAINT_MISMATCH_OK_DEFAULT)))
PRINT_CHECK_REGS = get_env_bool('PRINT_CHECK_REGS', str(int(PRINT_CHECK_REGS_DEFAULT)))
PRINT_WRITEBACK_TAINT = get_env_bool('PRINT_WRITEBACK_TAINT', str(int(PRINT_WRITEBACK_TAINT_DEFAULT)))
...
DUMP_WRITEBACK_TAINT = get_env_bool('DUMP_WRITEBACK_TAINT', str(int(DUMP_WRITEBACK_TAINT_DEFAULT)))
...
PRINT_MEM_LOADS_TAINT = get_env_bool('PRINT_MEM_LOADS_TAINT', str(int(PRINT_MEM_LOADS_TAINT_DEFAULT)))
PRINT_MEM_STORES = get_env_bool('PRINT_MEM_STORES', str(int(PRINT_MEM_STORES_DEFAULT)))
PRINT_MEM_STORES_TAINT = get_env_bool('PRINT_MEM_STORES_TAINT', str(int(PRINT_MEM_STORES_TAINT_DEFAULT)))
