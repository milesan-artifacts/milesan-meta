...
CHECK_REGS_TAINT_PRECISE_DEFAULT = False
CHECK_MEM_TAINT_PRECISE_DEFAULT = False
CHECK_MEM_DEFAULT = False
PRINT_CHECK_REGS_TAINT_DEFAULT = False
PRINT_CHECK_REGS_TAINT_MISMATCH_OK_DEFAULT = False
PRINT_CHECK_REGS_DEFAULT = False
PRINT_WRITEBACK_TAINT_DEFAULT = False
PRINT_WRITEBACK_DEFAULT = False
DUMP_WRITEBACK_DEFAULT = False
DUMP_WRITEBACK_TAINT_DEFAULT = False
...
PRINT_MEM_LOADS_TAINT_DEFAULT = False
PRINT_MEM_STORES_DEFAULT = False
PRINT_MEM_STORES_TAINT_DEFAULT = False
...
USE_MODELSIM_SERVER_DEFAULT = False
