...
TAINT_EN =  get_env_bool("EN_TAINT",EN_TAINT_DEFAULT)
...
MIN_WEIGHT_TAINT = 0.01
MAX_WEIGHT_TAINT = 1

# The maximal probability proturbance introduced when a register is fully tainted i.e. relative taint hamming weight is one.
REGPICK_PROTUBERANCE_RATIO_TAINT_POS = 0.6 # Prefer tainted registers for rs.
REGPICK_PROTUBERANCE_RATIO_TAINT_NEG = 0.8 # Prefer untainted registers for rd.
