...
from milesan.util import INSTRUCTIONS_BY_ISA_CLASS, IntRegIndivState
...
def _create_ImmRdInstruction(instr_str: str, fuzzerstate, iscompressed: bool):
    ...
    return ImmRdInstruction_taint(fuzzerstate,instr_str, rd, imm, 0, iscompressed)
...
def _create_RegImmInstruction(instr_str: str, fuzzerstate, iscompressed: bool):
    ...
    return RegImmInstruction_taint(fuzzerstate, instr_str, rd, rs1, imm, 0, iscompressed)
...
def _create_BranchInstruction(instr_str: str, fuzzerstate, curr_addr: int, iscompressed: bool):
    ...
    return BranchInstruction_taint(fuzzerstate, instr_str, rs1, rs2, imm, 0x0, None, iscompressed)
...
def create_speculative_instrs(fuzzerstate, curr_addr: int, domain: tuple):
    ...
    if isa_class == ISAInstrClass.DESCEND_PRV:
        ...
        instrs = [PrivilegeDescentInstruction_taint(fuzzerstate, is_mret=fuzzerstate.privilegestate.privstate==PrivilegeStateEnum.MACHINE)]
    ...
    for instr in instrs:
        ...
        if isinstance(instr, GenericCSRWriterInstruction_taint):
