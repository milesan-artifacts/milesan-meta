...
def is_tolerate_ibex_div_ct_violation():
    return TOLERATE_IBEX_DIV_CT_VIOLATION
if TOLERATE_IBEX_DIV_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_DIV_CT_VIOLATION')


def is_tolerate_ibex_divu_ct_violation():
    return TOLERATE_IBEX_DIVU_CT_VIOLATION
if TOLERATE_IBEX_DIVU_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_DIVU_CT_VIOLATION')


def is_tolerate_ibex_divw_ct_violation():
    return TOLERATE_IBEX_DIVW_CT_VIOLATION
if TOLERATE_IBEX_DIVW_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_DIVW_CT_VIOLATION')


def is_tolerate_ibex_divuw_ct_violation():
    return TOLERATE_IBEX_DIVUW_CT_VIOLATION
if TOLERATE_IBEX_DIVUW_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_DIVUW_CT_VIOLATION')


def is_tolerate_ibex_rem_ct_violation():
    return TOLERATE_IBEX_REM_CT_VIOLATION
if TOLERATE_IBEX_REM_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_REM_CT_VIOLATION')


def is_tolerate_ibex_remu_ct_violation():
    return TOLERATE_IBEX_REMU_CT_VIOLATION
if TOLERATE_IBEX_REMU_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_REMU_CT_VIOLATION')


def is_tolerate_ibex_remw_ct_violation():
    return TOLERATE_IBEX_REMW_CT_VIOLATION
if TOLERATE_IBEX_REMW_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_REMW_CT_VIOLATION')


def is_tolerate_ibex_remuw_ct_violation():
    return TOLERATE_IBEX_REMUW_CT_VIOLATION
if TOLERATE_IBEX_REMUW_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_REMUW_CT_VIOLATION')

def is_tolerate_ibex_mul_ct_violation():
    return TOLERATE_IBEX_MUL_CT_VIOLATION
if TOLERATE_IBEX_MUL_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_MUL_CT_VIOLATION')

def is_tolerate_ibex_mulh_ct_violation():
    return TOLERATE_IBEX_MULH_CT_VIOLATION
if TOLERATE_IBEX_MULH_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_MULH_CT_VIOLATION')

def is_tolerate_ibex_mulhsu_ct_violation():
    return TOLERATE_IBEX_MULHSU_CT_VIOLATION
if TOLERATE_IBEX_MULHSU_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_MULHSU_CT_VIOLATION')

def is_tolerate_ibex_mulhu_ct_violation():
    return TOLERATE_IBEX_MULHU_CT_VIOLATION
if TOLERATE_IBEX_MULHU_CT_VIOLATION:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_MULHU_CT_VIOLATION')

def is_tolerate_ibex_minstret():
    return TOLERATE_IBEX_MINSTRET
if TOLERATE_IBEX_MINSTRET:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_MINSTRET')

def is_tolerate_ibex_mcause():
    return TOLERATE_IBEX_MCAUSE
if TOLERATE_IBEX_MCAUSE:
    print('WARNING: Tolerating one bug: TOLERATE_IBEX_MCAUSE')
###
# CVA6
###
